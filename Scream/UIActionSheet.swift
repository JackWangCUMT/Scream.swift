...
public extension UIActionSheet {
    ...
    public func cancel(action:(@autoclosure () -> ())?) -> UIActionSheet {
        self.__delegate?.cancel = action
        return self;
    }
    
    public func willPresent(action:(@autoclosure () -> ())?) -> UIActionSheet {
        self.__delegate?.willPresent = action
        return self;
    }
    
    public func didPresent(action:(@autoclosure () -> ())?) -> UIActionSheet {
